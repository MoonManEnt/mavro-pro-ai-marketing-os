...
const ContentWizard: React.FC = () => {
  ...
  const generateContentSuggestions = async () => {
    ...
    const suggestions: ContentSuggestion[] = [
      {
        id: '1',
        text: "🌟 Transform your business with AI-powered marketing automation! From lead generation to customer retention, discover how smart technology can boost your ROI by 300%. Ready to revolutionize your marketing strategy?",
        tone: 'energetic',
        length: 187,
        hashtags: ['#AIMarketing', '#MarketingAutomation', '#BusinessGrowth', '#ROI', '#Innovation'],
        engagement: '95%'
      },
      {
        id: '2',
        text: "The future of marketing is here. Our AI-driven platform helps businesses like yours streamline campaigns, optimize ad spend, and deliver personalized customer experiences that drive results. Join thousands of satisfied clients.",
        tone: 'professional',
        length: 212,
        hashtags: ['#MarketingTech', '#AIInnovation', '#BusinessSolutions', '#CustomerExperience'],
        engagement: '87%'
      },
      {
        id: '3',
        text: "Hey entrepreneurs! 👋 Tired of spending hours on manual marketing tasks? Let our AI do the heavy lifting while you focus on what you do best - running your business! See how we've helped 10,000+ businesses grow.",
        tone: 'casual',
        length: 201,
        hashtags: ['#Entrepreneurs', '#MarketingHacks', '#BusinessTips', '#Automation', '#Growth'],
        engagement: '92%'
      }
    ];
